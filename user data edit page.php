<?php
	...
	$sql = "SELECT * from rendement where id = ?";
	$q = $pdo->prepare($sql);
	$q->execute(array($id));
			...
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
				...
				<form class="form-horizontal" action="user data edit tb.php?id=<?php echo $id?>" method="post">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="First_Name" type="text"  placeholder="" value="<?php echo $data['First_Name'];?>" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="Last_Name" type="text" placeholder="" value="<?php echo $data['Last_Name'];?>" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="Temps" type="datetime-local"  placeholder="" value="<?php echo $data['Temps'];?>" required>
						</div>
					</div>
					<div class="control-group">
